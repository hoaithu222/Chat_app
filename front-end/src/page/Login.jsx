      ...
      <div className="shadow-2xl shadow-slate-300 p-4 sm:p-6 md:p-8 lg:p-10 rounded-xl ">
        ...
        <div className="mt-2">
          ...
          >
            ...
            />
            <button className="px-3 py-1 sm:px-4 sm:py-2 md:px-5 md:py-2  rounded-md mt-4 sm:mt-5 md:mt-6 lg:mt-7 text-white bg-red-300  mx-auto flex items-center justify-center">
